...
namespace Microsoft.MixedReality.Toolkit.Examples.Experimental.DialogTest
{
    ...
    public class DialogExampleController : MonoBehaviour
    {
        ...
        public void OpenPlacementConfirmationDialogeSmall()
        {
            Dialog.Open(DialogPrefabSmall, DialogButtonType.OK, "Massey AR Fire Escape", "Firelocation Saved", true);
        }

        public void OpenSuccessDialogeSmall()
        {
